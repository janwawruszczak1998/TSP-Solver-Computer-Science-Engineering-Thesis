...
protected:
    void calculate_route(Ant *, std::vector <std::vector<unsigned>> &, tsp::Graph<double, std::vector> &,
    ...
    void update_pheromones(std::vector <std::vector<double>> &, std::vector <std::vector<unsigned>> &,
                           tsp::Graph<double, std::vector> &);

    unsigned route_value(std::vector<unsigned> &, tsp::Graph<double, std::vector> &);

    void route(Ant *ant, std::vector <std::vector<unsigned>> &, tsp::Graph<double, std::vector> &,
               std::vector <std::vector<double>> &);
};
