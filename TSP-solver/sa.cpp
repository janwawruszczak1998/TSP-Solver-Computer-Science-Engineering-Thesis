    ...
    while (run_flag == true) {
        ...
        while (temperature > 0.1) {
            ...
            while (rep-- > 0) {
                ...
                unsigned difference = static_cast<unsigned>(step_val -
                                                            curr_val); //roznica rozwiazan najlepszego i aktualnego
...
double
SA::get_probability(unsigned difference, double temperature) //Funkcja określa jak słabe jest sugerowane rozwiązanie
{
