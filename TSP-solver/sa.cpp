...
SA::SA(tsp::Graph<double, std::vector>& graph_, unsigned& result_) : Strategy(graph_, result_)
{
...
void SA::calculate_solution() {
    std::vector<unsigned> solution;
      unsigned result = random_path(solution, graph);   //pierwsze losowe rozwiazanie
