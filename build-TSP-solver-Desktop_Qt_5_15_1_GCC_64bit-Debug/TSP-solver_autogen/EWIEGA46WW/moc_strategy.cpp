...
QT_MOC_LITERAL(1, 9, 9), // "update_ui"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "Strategy\0update_ui\0"
};
...
void Strategy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Strategy *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (Strategy::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Strategy::update_ui)) {
                *result = 0;
                return;
            }
        }
